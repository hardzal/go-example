...
import (
	...
	"github.com/hardzal/go-example/mux-mongo-api/models"
	"github.com/hardzal/go-example/mux-mongo-api/responses"
...
func DeleteAUser() http.HandlerFunc {
	return func(rw http.ResponseWriter, r *http.Request) {
		...
		if result.DeletedCount < 1 {
			...
			response := responses.UserResponse{Status: http.StatusNotFound, Message: "error", Data: map[string]interface{}{"data": "User succesfully deleted!"}}
			json.NewEncoder(rw).Encode(response)
		}
	}
}
